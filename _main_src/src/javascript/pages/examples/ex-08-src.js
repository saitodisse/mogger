...
module.exports = function() {
    ...
    var callSources = function () {
        simple_obj_1.method_1_A(1);
        simple_obj_1.method_1_B(1,2);
        simple_obj_2.method_2_A( {a:'aValue'} );
        simple_obj_2.method_2_B( ['1', 2, [{b:'bValue'}]]);
    };
