...
module.exports = function() {
    return [
        ...
        },
        {
            ...
            script: require('../pages/examples/ex-08-src')
        },
        {
            id: 'ex-09',
            title: 'pointcut',
            ...
            script: require('../pages/examples/ex-09-src')
        },
        {
            id: 'ex-10',
            title: 'interceptors',
            ...
            script: require('../pages/examples/ex-10-src')
        },
        {
            id: 'ex-11',
            ...
            script: require('../pages/examples/ex-11-src')
        },
    ];
};